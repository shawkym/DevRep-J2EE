...
.constant("MEDIA_URL", "https://api.cosmicjs.com/v1/devrep/media")
.constant("URL", "https://api.cosmicjs.com/v1/")
.constant("READ_KEY", "IxcYbHRjYrK3HEKvofPYaShnwPTGZJ4zlgjbqRqifdFYnUKXU9")
.constant("WRITE_KEY", "ZbDIaM3LlErqv6B4vIhIWvHrj4UZ8kZRAoLtlePfDeCLAjieI0")
.constant("BUCKET_SLUG","devrep");
...
(function () {
    ...
    function run($rootScope, $cookieStore, $state, crAcl, $window) {
        ...
        $rootScope.$on('$stateChangeSuccess', function (event, current, previous) {
            $window.document.title = current.title ? current.title + ' - DEVREP CONFERENCE' : 'DEVREP CONFERENCE';
        });
...
(function () {
    ...
    function GlobalCtrl($scope, Notification, $log, $rootScope, $state) {
        ...
        vm.title = $rootScope.title ? $rootScope.title + ' - DEVREP CONFERENCE' : 'DEVREP CONFERENCE';
